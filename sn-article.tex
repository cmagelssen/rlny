...
In contemporary teaching practice, performers commonly acquire movement strategies through instructional methods, wherein a coach or teacher guides the learner on 'what to do' (e.g., suggesting taking a shorter line around the gate), followed by corrective feedback (e.g., encouraging the learner to further shorten the line) \cite{williams_practice_2005, williams_effective_2023, hodges_modelling_2002}. This teaching strategy can be likened to what motor learning refers to as supervised learning, where the teaching signal for skill improvement represents the difference between the desired skill and the performer's movement outcome \cite{jordan_forward_1992, wolpert_motor_2010, doya_complementary_2000}. Through practice, this teaching signal can bring the learner closer to executing what is assumed to be the correct choice. The question, however, is whether this is the most effective for training learners to choose effective strategies. 
