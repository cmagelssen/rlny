...
\title[Article Title]{Reinforcement learning enhances training and performance in skilled alpine skiers compared to traditional coaching instruction}
...
\author[1]{\fnm{Matthias} \sur{Gilgien}}\email{matthiasg@nih.no}


\author[2]{\fnm{Simen Leithe} \sur{Tajet}}\email{simenlt@nih.no}


\author[1]{\fnm{Thomas} \sur{Losnegard}}\email{thomasl@nih.no}

\author[1]{\fnm{Per} \sur{Haugen}}\email{perh@nih.no}

\author[3]{\fnm{Robert} \sur{Reid}}\email{robert.reid@skiforbundet.no}


\author[4]{\fnm{Romy} \sur{Frömer}}\email{r.froemer@bham.ac.uk}


\affil*[1]{\orgdiv{Department for Physical Performance}, \orgname{Norwegian School of Sport Sciences}, \orgaddress{\street{Sognsveien 220}, \city{Oslo}, \postcode{0863}, \state{Oslo}, \country{Norway}}}

\affil[2]{\orgdiv{Department of Sport and Social Science}, \orgname{Norwegian School of Sport Sciences}, \orgaddress{\street{Sognsveien 220}, \city{Oslo}, \postcode{0863}, \state{Oslo}, \country{Norway}}}

\affil[3]{\orgdiv{Department for alpine skiing }, \orgname{The Norwegian Ski Federation}, \orgaddress{\street{Sognsveien 75 B1}, \city{Oslo}, \postcode{0840}, \state{Oslo}, \country{Norway}}}

\affil[4]{\orgdiv{School of Psychology}, \orgname{University of Birmingham}, \orgaddress{\street{Edgbaston Park Rd}, \city{Birmingham}, \postcode{B15 2TT}, \state{Birmingham}, \country{United Kingdom}}}
...
\keywords{Reinforcement learning, Supervised learning, Talent development, Expertise development, Alpine ski racing, Reward, Strategy learning}
...
\begin{tabular}{lrrrrrrrr}
 ...
 (Intercept) & 16.62 & 0.13 & 3.93 & 16.27-16.97 & 132.69 &  $<$  0.001 \\ 
  ...
  sd(free choice 2) & 0.22 &  &  &  &  &  &  \\ 
   ...
   \hline
\end{tabular}
\footnotetext{Formula: racetime $\sim$ treatment / session + (1 $|$skigroup) + (1 + session $|$ skigroup:skier)}
\end{table}
...
\begin{tabular}{lrrrrrrrr}
 ...
 free choice 1 & -0.39 & 0.02 & 92.32 & -0.43--0.35 & -20.09 &  $<$  0.001 \\ 
  ...
  sd(Observation) & 0.21 &  &  &  &   &  \\ 
   \hline
\end{tabular}
\footnotetext{Formula: racetime $\sim$ session / treatment + (1 $|$skigroup) + (1 + session $|$ skigroup:skier)}
\end{table}
...
\begin{tabular}{llrrrrrrr}
 ...
 Contrast & Treatment & Estimate & SE & df & CI & z & p \\ 
  ...
  transfer - retention & slfc & 0.05 & 0.06 & Inf & -0.07-0.18 & 0.85 &    0.396 \\ 
   \hline
\end{tabular}
\footnotetext{Formula: glmer(chosetheorybest $\sim$ treatment * session + (1 $|$ skigroup/skier).}
...
\begin{tabular}{rllrrrrrrl}
 ...
 rl - slfc & block2 & 0.01 & 0.12 & Inf & -0.22-0.24 & 0.12 &    0.904 \\ 
  ...
  rl - slfc & transfer & 0.00 & 0.09 & Inf & -0.17-0.17 & 0.00 &    0.999 \\ 
   \hline
\end{tabular}
\footnotetext{Formula: glmer(choseestimatedbest $\sim$ treatment * session + (1 $|$ skigroup/skier).}
\footnotetext{rl = reinforcement learning; slfc = supervised (free choice) learning}
\end{table}
...
\begin{tabular}{lrrrrrrr}
 ...
 slts : c & -0.95 & 0.11 & -1.16--0.74 & -8.94 &  $<$  0.001 \\ 
  ...
  slts : d : ranktime & -0.15 & 0.04 & -0.22--0.08 & -4.18 &  $<$  0.001 \\ 
   \hline
\end{tabular}
\footnotetext{Formula: lm(value $\sim$ treatment/strategy * ranktime)}
...
\begin{tabular}{lrrrrrrr}
 ...
 (Intercept) & 2.50 & 0.03 & 2.44-2.56 & 85.64 &  $<$  0.001 \\ 
   ...
   \hline
\end{tabular}
\footnotetext{Formula: lm(value $\sim$ strategy / treatment * ranktime)}
...
%   \hline
%\end{tabular}
%\footnotetext{Formula: lmer(racingtime $\sim$ treatment / strategy + (1 | skigroup / skier)}
...
\footnotetext{For this model we used a sliding difference contrast coding scheme}
\end{table}
...
(Intercept) & 16.88 & 0.11 & 3.99 & 16.56-17.20 & 147.94 &  $<$  0.001 \\ 
  ...
  sd(Observation) & 0.19 &  &  &  &  &    \\ 
   \hline
\end{tabular}
\footnotetext{Formula: lmer(racingtime $\sim$ strategy / treatment + (1 $|$ skigroup / skier)}
\footnotetext{a="stand against", b="extend", c="rock skis forward", d="extend with rock skis forward"}
\end{table}
...
(Intercept) & 16.80 & 0.11 & 4.05 & 16.48-17.12 & 146.23 &  $<$  0.001 \\ 
  ...
  sd(Observation) & 0.19 &  &  &  &  &   \\ 
   \hline
\end{tabular}
\footnotetext{Formula: lmer(racetime $\sim$ treatment * strategy / sessionnumber + (1 $|$ skigroup / skier))}
...
(Intercept) & 16.80 & 0.11 & 4.05 & 16.48-17.12 & 146.23 &  $<$  0.001 \\ 
 b & -0.44 & 0.02 & 1378.01 & -0.48--0.40 & -20.15 &  $<$  0.001 \\ 
  ...
  sd(Observation) & 0.19 &  &  &  &  &   \\ 
   \hline
\end{tabular}
\footnotetext{Formula: lmer(racetime $\sim$ strategy / treatment * sessionnumber + (1 $|$ skigroup / skier))}
\footnotetext{rl = reinforcement learning; slfc = supervised (free choice) learning, a="stand against", b="extend", c="rock skis forward", d="extend with rock skis forward"}
\end{table}
...
(Intercept) & 16.59 & 0.16 & 6.81 & 16.20-16.98 & 101.76 &  $<$  0.001 \\ 
 ...
 sd(Intercept) & 0.51 &  &  &  &  &   \\ 
  ...
  sd(Observation) & 0.18 &  &  &  &  &   \\ 
   \hline
\end{tabular}
\footnotetext{Formula: lmer(racetime $\sim$ treatment / sessionnumber + (1 $|$ skigroup / skier))}
\footnotetext{rl = reinforcement learning; slfc = supervised (free choice) learning, slts = supervised (target skill) learning, a="stand against", b="extend", c="rock skis forward", d="extend with rock skis forward"}
\end{table}
